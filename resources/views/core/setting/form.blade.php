    ...
    <x-card>
        <x-form :model="$model" :upload="true">
            ...
            @bind($model)
                ...
                <x-form-select col="2" name="debug_enable" :default="env('APP_DEBUG')" label="Debug Enable" :options="$active" />
                <x-form-select col="2" name="telescope_enable" :default="env('TELESCOPE_ENABLED')" label="Telescope" :options="$active" />
                <x-form-select col="2" name="debugbar_enable" :default="env('BREADCRUMB_ENABLED')" label="Debugbar" :options="$active" />
